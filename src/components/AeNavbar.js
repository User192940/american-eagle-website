...
export function AeNavbar({
  ...
  return <nav id={`${top ? "top" : "normal"}`} className="top-navigation h-12 w-full bg-white border-b-black z-10 lg:mt-[68px]">
        <ul className="flex flex-row lg:bg-neutral-200 justify-around lg:justify-end list-none">
        <li className="max-lg:hidden lg:visible lg:bg-white lg:leading-10 lg:ml-14 lg:w-[200px] text-blue-950">
          <Link to="/">
            AMERICAN EAGLE
            </Link>
          </li>
          <li className="max-lg:hidden lg:visible lg:mr-auto lg:w-[92px] lg:leading-10 text-green-700">
            aerie
          </li>
          <li className="md:h-[30] md:w-[27px] md:top-[1px] h-10 w-8 pt-2 lg:hidden">
            <div className=''>
            <input onClick={changeUI} type='checkbox' className='hidden checked' id='checked' />
            <label className='h-10 w-8 block cursor-pointer' for="checked">
          ...
          <li className="lg:m-[.6rem] lg:p-0 md:h-[30] md:w-[27px] md:top-[1px] h-[28px] pt-2 hover:cursor-pointer">
          ...
          <li className="md:h-[30] md:w-[27px] md:top-[1px] h-[28px] pt-2 hover:cursor-pointer lg:hidden">
          ...
          <li onClick={onOpen} className="lg:m-[.6rem] lg:p-0 md:h-[30] md:w-[27px] md:top-[1px] h-[28px] pt-2 hover:cursor-pointer">
