...
export function AeNavbar({
  ...
  return <nav id={`${top ? "top" : "normal"}`} className="top-navigation h-12 w-full bg-white border-b-black z-10">
        <ul className="flex flex-row justify-around list-none">
          ...
          <li onClick={onOpen} className="md:h-[30] md:w-[27px] md:top-[1px] h-[28px] pt-2 hover:cursor-pointer">
